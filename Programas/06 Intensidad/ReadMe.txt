========================================================================
    APLICACIÓN DE CONSOLA: Intensidad Información general 
    del proyecto
========================================================================

AppWizard ha creado esta aplicación Intensidad.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la Intensidad aplicación.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado Intensidad.pch y un archivo de 
