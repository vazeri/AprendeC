...
void lista::actualizar(nodo* p)
{
	...
	cout<<"Elija la opcion que desea actualizar: "<<endl;
...
do{
            ...
            if(!file){cout<<"No existe el archivo"; system("pause");}
        ...
        file.close();
 cout<<"Informacion Guardada en archivo Base de Datos \n"<<endl;
        system("pause");
	}

void lista::leer()
{
 cout<<"Leyendo archivo Base de Datos \n"<<endl;
      string line;
